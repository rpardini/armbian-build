...
if test "${earlycon}" = "on"; then setenv consoleargs "earlycon=aml-uart,0xfe07a000 ${consoleargs}"; fi
...
setenv bootargs "root=${rootdev} rootwait rootfstype=${rootfstype} ${consoleargs} no_console_suspend mac=${eth_mac} khadas.serial=${usid} partition_type=generic ${extraargs} ${extraboardargs}"
