### rpardini's fork of the Armbian build system
...
- Adds support for cloud-init, netplan, and generally behaves more like an Ubuntu Cloud instance or the Ubuntu
  RaspberryPi build.
- **Using a system extensibility system** called _extensions_ which maybe one day might be upstreamed. Right now does not
  look like it.
