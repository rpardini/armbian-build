...
function pre_customize_image__080_add_tailscale_package() {
	...
	chroot_sdcard curl -fsSL "https://pkgs.tailscale.com/stable/ubuntu/${RELEASE}.gpg" "|" apt-key add -
	chroot_sdcard curl -fsSL "https://pkgs.tailscale.com/stable/ubuntu/${RELEASE}.list" "|" tee /etc/apt/sources.list.d/tailscale.list
