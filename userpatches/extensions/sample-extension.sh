...
###  optionally prefix a package with a Docker-layer group ("group::pkg"); unprefixed goes to "core".
add_host_dependencies__be_more_awesome() {
	...
	# EXTRA_BUILD_DEPS+=("some-package" "fs-tools::another-package") # append packages to the array here
}
