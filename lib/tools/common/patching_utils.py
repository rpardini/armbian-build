...
class PatchFileInDir:
	...
	def split_patches_from_file(self) -> list["PatchInPatchFile"]:
		...
		if self.patch_dir.is_autogen_dir:
			...
			# bare_patch.problems.append("bytes")
			bare_patch.problems.append("autogen")
...
class PatchInPatchFile:
	...
	def parse_patch(self):
		# Hack: don't parse if autogenned.
		if self.parent.patch_dir.is_autogen_dir:
			log.warning(
				f"Skipping parsing of autogenned patch {self.counter} in file {self.parent.full_file_path()}")
			return
