...
# This could be inlined above.
function add_host_dependencies__distcc_host_deps() {
	display_alert "add_host_dependencies__distcc_host_deps" "add_host_dependencies__distcc_host_deps :: ${ARMBIAN_COMMAND}" "warn"
	export EXTRA_BUILD_DEPS="${EXTRA_BUILD_DEPS} distcc"
}
