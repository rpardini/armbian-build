...
function artifact_armbian-base-files_prepare_version() {
	...
	case "${RELEASE}-${ARCH}" in
		...
		"oracular-amd64") base_files_wanted_upstream_version="13.3ubuntu5" base_files_wanted_upstream_filename="base-files_13.3ubuntu5_amd64.deb" base_files_wanted_deb_down_url="http://archive.ubuntu.com/ubuntu/pool/main/b/base-files/base-files_13.3ubuntu5_amd64.deb" ;;
		"oracular-arm64") base_files_wanted_upstream_version="13.3ubuntu5" base_files_wanted_upstream_filename="base-files_13.3ubuntu5_arm64.deb" base_files_wanted_deb_down_url="http://ports.ubuntu.com/pool/main/b/base-files/base-files_13.3ubuntu5_arm64.deb" ;;
		"oracular-armhf") base_files_wanted_upstream_version="13.3ubuntu5" base_files_wanted_upstream_filename="base-files_13.3ubuntu5_armhf.deb" base_files_wanted_deb_down_url="http://ports.ubuntu.com/pool/main/b/base-files/base-files_13.3ubuntu5_armhf.deb" ;;
		"oracular-riscv64") base_files_wanted_upstream_version="13.3ubuntu5" base_files_wanted_upstream_filename="base-files_13.3ubuntu5_riscv64.deb" base_files_wanted_deb_down_url="http://ports.ubuntu.com/pool/main/b/base-files/base-files_13.3ubuntu5_riscv64.deb" ;;
