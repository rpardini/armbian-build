...
function compile_kernel() {
	...
	LOG_SECTION="kernel_prepare_bare_repo_from_bundle" do_with_logging_unless_user_terminal do_with_hooks kernel_prepare_bare_repo_from_bundle # this sets kernel_git_bare_tree
